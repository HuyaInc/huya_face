...
def parse_arguments(argv):
  ...
  parser.add_argument('--facescrub-noises', type=str, help='', default='~/huya_face/face_datasets/megaface_data/eval_set/facescrub_noises.txt')
  parser.add_argument('--algo', type=str, help='', default='r100ii')
  parser.add_argument('--facescrub-lst', type=str, help='', default='~/huya_face/face_datasets/megaface_data/eval_set/facescrub_lst')
  parser.add_argument('--feature-dir-input', type=str, help='', default='~/huya_face/feature_out')
  parser.add_argument('--feature-dir-out', type=str, help='', default='~/huya_face/feature_out_clean')
